...
## Inferencias respecto a la respuesta media $\boldsymbol{E[Y\vert x_0]}$ y valores futuro $\boldsymbol{Y\vert x_0 = y_0}$

Interesa realizar inferencias sobre la respuesta, para un valor apropiado $X = x_0$, así:

* Estimación puntual y por intervalo de la respuesta media $E[Y\vert x_0]$.
