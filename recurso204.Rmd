...
El intercepto $\beta_{0}$ corresponde al valor que puede tomar la variable $Y$ cuando el valor de $X=0$ y corresponde al valor de corte en el eje $y$ en el plano carteciano. 
...
$$
{T}={\frac{\widehat\beta_0-\beta_0}{\sigma_{\widehat{\beta}_{0}}} \sim t_{n-2}}
$$
