...
Donde $Y_{i}$, es la variable respuesta o dependiente y el conjunto de variables $X_{1},X_{2}, \ldots X_{k}$, conforman las variabies independientes o regresoras. Adicionalmente el modelo contiene una variable $\varepsilon$, que posee caracteristicas especiales.
